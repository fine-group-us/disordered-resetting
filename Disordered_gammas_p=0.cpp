...
int main() {
	...
	// WE OBTAIN THE FTP OF EACH SIMULATION IN THIS SCRIPT. (P=0)
	...
	// INPUT: GAMMA1, GAMMA2, PTARGET=0, NRUNS, FILE
	...
	std::string MFTPFile = "Results_Paper/Mapping_r1/p=0/Results_" + std::to_string(File) + ".dat";
